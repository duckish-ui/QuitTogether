...
class BudgetsRecord extends FirestoreRecord {
  ...
  // "budgetDrop" field.
  String? _budgetDrop;
  String get budgetDrop => _budgetDrop ?? '';
  bool hasBudgetDrop() => _budgetDrop != null;

  // "budgetDate" field.
  DateTime? _budgetDate;
  DateTime? get budgetDate => _budgetDate;
  bool hasBudgetDate() => _budgetDate != null;
  ...
  void _initializeFields() {
    ...
    _budgetDrop = snapshotData['budgetDrop'] as String?;
    _budgetDate = snapshotData['budgetDate'] as DateTime?;
  }
...
class BudgetsRecordDocumentEquality implements Equality<BudgetsRecord> {
  ...
  bool equals(BudgetsRecord? e1, BudgetsRecord? e2) {
    return e1?.budetName == e2?.budetName &&
        ...
        e1?.budgetDrop == e2?.budgetDrop &&
        e1?.budgetDate == e2?.budgetDate;
  }
